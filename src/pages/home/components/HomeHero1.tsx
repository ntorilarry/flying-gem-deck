      ...
      <section className=" flex w-full h-[100vh] items-center justify-center">
        <div className="container px-4 mx-auto">
          ...
          <div className="text-center">
            <span className="inline-block mb-4 text-sm text-white font-medium tracking-tighter">
              Welcome to Flying-Gem Consulting
            </span>
            <h2 className="font-heading mb-6 text-5xl lg:text-6xl xl:text-7xl text-white tracking-9xl  mx-auto">
              <Typewriter
                key="unique-key"
            ...
            <p className="my-8 text-base font-normal text-white md:max-w-3xl mx-auto">
